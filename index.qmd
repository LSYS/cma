...
* [x] use trends of(GS + psychinfo)
* [x] check writing (stopped at endnote)
* [x] figure out footnotes
* [x] figure out preambles
...
Since it's increasingly popular and results may influence policy and practice, I thought I should at least gain some literacy on it.
...
<br>
***Source:*** Figure 1 of @Nguyen2021-oj. Reproduced [from v1](https://arxiv.org/abs/1904.08515v1) with permission.
